...
public class Crate extends Destructible {
    ...
    TextureAtlas.AtlasRegion idle = atlas.findRegion("breakable_crate_small");
    TextureAtlas.AtlasRegion exploding1 = atlas.findRegion("crate_break1");
    TextureAtlas.AtlasRegion exploding2 = atlas.findRegion("crate_break2");
    TextureAtlas.AtlasRegion exploding3 = atlas.findRegion("crate_break3");
    TextureAtlas.AtlasRegion exploding4 = atlas.findRegion("crate_break4");
    TextureAtlas.AtlasRegion exploding5 = atlas.findRegion("crate_break5");

    public Crate(float sX, float sY, TextureAtlas atlas, TiledMapTileLayer layer, GameScreen screen) {
