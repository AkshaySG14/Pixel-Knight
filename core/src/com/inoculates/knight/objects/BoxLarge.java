...
public class BoxLarge extends Destructible {
    Animation explode;

    TextureAtlas.AtlasRegion idle = atlas.findRegion("box");
    TextureAtlas.AtlasRegion exploding1 = atlas.findRegion("box_break1");
    TextureAtlas.AtlasRegion exploding2 = atlas.findRegion("box_break2");
    TextureAtlas.AtlasRegion exploding3 = atlas.findRegion("box_break3");
    TextureAtlas.AtlasRegion exploding4 = atlas.findRegion("box_break4");
    TextureAtlas.AtlasRegion exploding5 = atlas.findRegion("box_break5");

    public BoxLarge(float sX, float sY, TextureAtlas atlas, TiledMapTileLayer layer, GameScreen screen) {
